...
* Included product features, such as shared agents
* Trial length
...
### Why does a shared-agent invite say the owner needs to upgrade?

Shared agents are a plan feature. The owner can still review existing agents, but adding collaborators, collaborator messaging links, and shared-agent runtime access may require an upgrade. Open **Settings** -> **Billing** and look for a plan that includes **Shared agents**.
